...
public async Task JoinSession(string sessionId)
{
    ...
    await Clients.Group(GetSessionName(sid))
        .SendAsync("SessionPresenceChanged", new { sessionId = sid, user?.UserId, user?.DisplayName, status = "joined" });
}
  ...
  public async Task LeaveSession(string sessionId)
{
    ...
    var user = GetUserInfo();
    await Clients.Group(GetSessionName(sid))
        .SendAsync("SessionPresenceChanged", new { sessionId = sid, user?.UserId, user?.DisplayName, status = "left" });
